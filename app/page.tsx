...
export default function Home() {
  return (
    <div className="h-svh">
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-[#fc6464]/10 to-white px-4 py-8">
      ...
      <div className="flex gap-6 mb-8 flex-col lg:flex-row">
        <Image src='/assets/frame1.png' alt="frame1" width={300} height={500} className="rounded-[3rem] shadow-lg" />
        <Image src='/assets/frame2.png' alt="frame2" width={300} height={500} className="rounded-[3rem] shadow-lg" />
      </div>
